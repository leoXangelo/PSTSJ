...
public class ScoreSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    public ScoreSenderReceiver(Context c, String urlAddress, String query, HorizontalBarChart chart, SwipeRefreshLayout refreshLayout) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                ScoreParser p = new ScoreParser(c, s, chart);
                p.execute();
