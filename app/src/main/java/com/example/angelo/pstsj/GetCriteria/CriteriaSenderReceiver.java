...
public class CriteriaSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    public CriteriaSenderReceiver(Context c, String urlAddress, String query, ListView lv, int ID, String jname, String pname, String pgender) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                CriteriaParser p = new CriteriaParser(c, s, lv, ID, jname, pname, pgender);
                p.execute();
