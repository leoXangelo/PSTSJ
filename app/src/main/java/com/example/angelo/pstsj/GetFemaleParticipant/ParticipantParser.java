...
import com.example.angelo.pstsj.CustomAdapters.FemaleListViewAdapter;
...
public class ParticipantParser extends AsyncTask<Void,Void,Integer> {
    ...
    public ParticipantParser(Context c, String data, ListView lv, View bottomSheet, ListView femaleSheet) {
        this.c = c;
        this.data = data;
        this.lv = lv;
    ...
    protected void onPostExecute(Integer integer) {
        ...
        if(integer==1)
        {
            ...
            FemaleListViewAdapter adapter = new FemaleListViewAdapter(c, participants, bottomSheet, femaleSheet);
