...
public class ParticipantSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    ListView maleSheet;
    public ParticipantSenderReceiver(Context c, String urlAddress, String query, ListView lv, SwipeRefreshLayout refresh, View bottomSheet, ListView maleSheet) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                ParticipantParser p = new ParticipantParser(c, s, lv, bottomSheet, maleSheet);
                p.execute();
