...
import com.example.angelo.pstsj.GetFemaleParticipant.ParticipantSenderReceiver;
...
public class FemaleActivity extends Fragment {
    public View view, bottomSheet;
    ListView femaleList, femaleSheet;
    DatabaseHelper db;
    Button btnClose;
    private SwipeRefreshLayout swipeRefreshLayout;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.activity_female, container, false);
        db = new DatabaseHelper(view.getContext());
        femaleList = (ListView) view.findViewById(R.id.femaleList);;
        femaleSheet = (ListView) view.findViewById(R.id.femaleSheet);
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(behavior.getState() == BottomSheetBehavior.STATE_COLLAPSED){
                    ...
                    femaleList.invalidateViews();
                    femaleSheet.invalidateViews();
                }
            }
        });
        if(behavior.getState() == BottomSheetBehavior.STATE_COLLAPSED){
    ...
    private void VerifyRank(final String jname, final String pname, final int rank, final float score, final String ename, final String pgender){
        class UploadImage extends AsyncTask<Bitmap,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FemaleActivity.this.getActivity(), "Verifying", "Please Wait...",true,false);
            }
